...
export class OAuthServer {
  ...
  public readonly publicUrl?: string | undefined;
  public readonly defaultApiKey?: string | undefined;
   ...
   */
  public getBaseUrl(req: IncomingMessage, defaultHost = '127.0.0.1', defaultPort = 3000): string {
    if (this.publicUrl) {
   ...
   */
  public getAuthorizationServerMetadata(baseUrl: string) {
    return {
      issuer: baseUrl,
   ...
   */
  public exchangeAuthCode(params: {
    code: string;
    codeVerifier: string;
   ...
   */
  public exchangeRefreshToken(refreshToken: string, clientId?: string): StoredToken {
   ...
   */
  public issueClientCredentialsToken(clientId: string, clientSecret?: string, scope?: string): StoredToken {
   ...
   */
  private issueTokens(clientId: string, scope?: string, ttlSeconds = 7200): StoredToken {
