...
import { formatSuccess, formatList, formatCreated, formatNotFound, } from '../utils/response.js';
...
// Handlers
// ============================================================================
export async function handleSearchBills(args) {
    try {
...
export async function handleGetBill(args) {
    try {
...
export async function handleCreateBill(args) {
    try {
...
export async function handleRecordBillPayment(args) {
    try {
